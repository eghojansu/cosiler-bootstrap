...
defined('CODECEPTION_PROJECT_ROOT') || define('CODECEPTION_PROJECT_ROOT', dirname(dirname(__DIR__)));
...
$configDistFile = CODECEPTION_PROJECT_ROOT . DIRECTORY_SEPARATOR . 'codeception.dist.yml';
$configFile = CODECEPTION_PROJECT_ROOT . DIRECTORY_SEPARATOR . 'codeception.yml';

if (isset($_SERVER['HTTP_X_CODECEPTION_CODECOVERAGE_CONFIG'])) {
    $configFile = CODECEPTION_PROJECT_ROOT . DIRECTORY_SEPARATOR . $_SERVER['HTTP_X_CODECEPTION_CODECOVERAGE_CONFIG'];
}
