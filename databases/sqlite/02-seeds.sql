...
('MRuPYseS', 'main', null, 'dashboard', null, null, 'speedometer', 1, 'seed', 'seed', DATE('NOW'), DATE('NOW')),
('dPZwZRZd', 'main', null, 'administration', null, 'admin', 'gear', 1, 'seed', 'seed', DATE('NOW'), DATE('NOW')),
('oDOdghbo', 'main', 'dPZwZRZd', 'users', null, null, null, 1, 'seed', 'seed', DATE('NOW'), DATE('NOW')),
